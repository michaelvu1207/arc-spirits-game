...
const explicitlyNew = [
	...
	'ml/experiments/v35-weco-recursive-autoresearch/p30-long-horizon/runtime/cumulative-phase0-spend.json',
	...
	'ml/v35_p30_analyzer_rehearsal_fixture.py',
	...
	'ml/test_v35_p30_analyzer_rehearsal.py',
