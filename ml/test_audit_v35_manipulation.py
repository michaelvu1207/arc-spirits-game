...
from audit_v35_manipulation import ARMS, REPLICATES, evaluate_gates
...
class V35ManipulationGateTest(unittest.TestCase):
    def test_accepts_two_of_three_replicates(self) -> None:
        models = fixture()
        models["c"]["late-reweighted"]["kl"]["overall"] = 0.004
