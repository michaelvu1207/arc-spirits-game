...
observation features. The current encoder v1.3 appends 105 engine-cycle/player-count features
(83 -> 188); the surgery also works for any earlier strict-prefix checkpoint.
...
Usage:
  python ml/expand_obs_dim.py --in ml/champions/ladder3/main-0-gen60.json \
      --out ml/warmstart/ladder4-main0-obs188.json --new-obs-dim 188
"""
